...
% Lower One-sided Case % 

function [Q,u] = QFindLower(n, Kl, delta, S1, S2, S3, S4, S5, S6, S7, a_shape, b_scale)
...
LCL0 = mu - delta * sqrt(var) ; 
LCL1 = mu - 0.5 * Kl * sqrt(var/n) - delta * sqrt(var) ; 
LCL2 = mu - 1.0 * Kl * sqrt(var/n) - delta * sqrt(var) ; 
LCL3 = mu - 1.5 * Kl * sqrt(var/n) - delta * sqrt(var) ; 
LCL4 = mu - 2.0 * Kl * sqrt(var/n) - delta * sqrt(var) ; 
LCL5 = mu - 2.5 * Kl * sqrt(var/n) - delta * sqrt(var) ; 
LCL6 = mu - 3.0 * Kl * sqrt(var/n) - delta * sqrt(var) ; 
