...
% Steady State %
% Subject tp EARL0 = tau %
% Same as EAATS-optimal design %
...
n = 5 ; % sample size 
dmin = -0.75 ; % minimum shift size 
dmax = -0.10 ; % maximum shift szie
                    ...
                    for S6 = S5:8
                        for S7 = S6:10
                            ...
                            if abs(EARL0 - EARLi) < 1 
                                EARL1 = EARLFindLowerSteady(n, K, dmin, dmax, S1, S2, S3, S4, S5, S6, S7, a_shape, b_scale) ;  
