...
function [EARL] = EARLFindUpperSteady(n, Ku, dmin, dmax, S1, S2, S3, S4, S5, S6, S7, a_shape, b_scale)
...
for i = 1:h
    ...
    ARL = ARLFindUpperSteady(n, Ku, d, S1, S2, S3, S4, S5, S6, S7, a_shape, b_scale) ; 
