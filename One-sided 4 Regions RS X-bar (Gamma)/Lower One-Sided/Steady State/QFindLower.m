...
function [Q,u] = QFindLower(n, Kl, delta, S1, S2, S3, S4, a_shape, b_scale)
...
LCL1 = mu - Kl * sqrt (var/n) - delta * sqrt(var) ;
LCL2 = mu - 2 * Kl * sqrt (var/n) - delta * sqrt(var) ;
LCL3 = mu - 3 * Kl * sqrt (var/n) - delta * sqrt(var) ;
