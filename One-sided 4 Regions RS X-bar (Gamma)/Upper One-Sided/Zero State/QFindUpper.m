...
% Upper One-sided RS X-bar Chart % 

function [Q,u] = QFindUpper(n, Ku, delta, S1, S2, S3, S4, a_shape, b_scale)
...
UCL1 = mu + Ku * sqrt (var/n) - delta * sqrt(var) ;
UCL2 = mu + 2 * Ku * sqrt (var/n) - delta * sqrt(var) ;
UCL3 = mu + 3 * Ku * sqrt (var/n) - delta * sqrt(var) ;
